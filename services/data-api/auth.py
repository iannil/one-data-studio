...
# 保持向后兼容性的别名
DATA_PERMISSIONS = ROLE_PERMISSIONS

# 数据集所有权检查 - 使用 shared 的 owner_or_admin 实现
def require_dataset_owner():
    """
    数据集所有权检查装饰器 (向后兼容)

    使用 shared/auth 的 owner_or_admin 替代
    """
    return owner_or_admin("dataset_id")
