...
## L2 数据底座层 (Data Foundation - Alldata Core)
...
## L4 应用编排层 (Application Layer - Bisheng Core)
...
### L2 → L4：知识增强查询
* Alldata 提供元数据用于 Text-to-SQL
* Alldata 管理向量数据库用于 RAG 检索
* Bisheng 统一调用两类数据源
