...
def create_test_knowledge_base():
    ...
    api_url = os.getenv('BISHENG_API_URL', 'http://localhost:8000')
...
def create_test_model():
    ...
    api_url = os.getenv('CUBE_API_URL', 'http://localhost:8002')
...
def wait_for_services():
    ...
    services = [
        ('Bisheng API', os.getenv('BISHENG_API_URL', 'http://localhost:8000') + '/api/v1/health'),
        ('Alldata API', os.getenv('ALLDATA_API_URL', 'http://localhost:8001') + '/api/v1/health'),
        ('Cube API', os.getenv('CUBE_API_URL', 'http://localhost:8002') + '/api/v1/health'),
    ]
